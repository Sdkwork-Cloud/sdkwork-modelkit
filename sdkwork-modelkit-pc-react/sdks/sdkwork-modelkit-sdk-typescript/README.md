# @sdkwork/modelkit-sdk-typescript

Domain: intelligence
Capability: modelkit-sdk
Package type: sdk-family
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/modelkit-sdk-typescript`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
