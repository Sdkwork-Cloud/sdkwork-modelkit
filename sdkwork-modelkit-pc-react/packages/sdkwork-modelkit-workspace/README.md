# @sdkwork/modelkit-workspace

Domain: intelligence
Capability: modelkit-workspace
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/modelkit-workspace`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
