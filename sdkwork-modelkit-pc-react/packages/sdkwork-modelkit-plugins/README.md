# @sdkwork/modelkit-plugins

Domain: intelligence
Capability: modelkit-plugins
Package type: react-package
Status: standard

This README is the SDKWork module entrypoint for `@sdkwork/modelkit-plugins`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
