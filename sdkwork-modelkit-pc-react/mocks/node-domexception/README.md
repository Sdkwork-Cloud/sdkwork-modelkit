...
Domain: intelligence
Capability: domexception
Package type: node-package
Status: standard

This README is the SDKWork module entrypoint for `node-domexception`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../../sdkwork-specs/`.
